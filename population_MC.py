...
def RunEpidemic(nPop, n0, nDays, contacts_mean, contacts_std, prob_infection):
    ...
    track_susceptible = np.zeros(nDays, dtype=int) #never been exposed that day
    ...
    for day in range(nDays):
        ...
        for index in infected_people: 
            ...
            if new_infections > 0:
                ...
                if actual_new_infections>0:
                    for new_infection in infected_person.get_recent_infections():
                        if pop.infect(index=new_infection, day=day) == False:
                            print("Problem")
            ...
            if is_cured:
                pop.cure(index=infected_person.get_index(), day=day)

        
        print("Day: {}, infected: {}, recovered: {}".format(day, nInfected, nRecovered))
