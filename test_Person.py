...
#         pass
    ...
    def test_check_cured(self):
        ...
        person1 = Person.Person(1, infected=True, sim_obj=self.sim_obj, infected_day=infected_day, cure_days=cure_days)
        ...
        person2 = Person.Person(2, infected=True, sim_obj=self.sim_obj, infected_day=infected_day, cure_days=cure_days)
        ...
        person3 = Person.Person(3, sim_obj=self.sim_obj, infected=False)
    ...
    def test_infect(self):
        ...
        infected_day, cure_days = 10, 5
        person1 = Person.Person(1, sim_obj=self.sim_obj, infected=False, recovered=False)
        ...
        person2 = Person.Person(2, sim_obj=self.sim_obj, infected=True, recovered=False)
        self.assertFalse(person2.infect(day=infected_day)) # Should not get infected - already infected
        
        person3 = Person.Person(3, sim_obj=self.sim_obj, infected=False, recovered=True)
        self.assertFalse(person3.infect(day=infected_day)) # Should not get infected - already recovered MIGHT CHANGE
        
        person4 = Person.Person(4, sim_obj=self.sim_obj, infected=False, recovered=False)
